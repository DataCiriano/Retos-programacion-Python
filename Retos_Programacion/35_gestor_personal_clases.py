"""
* EJERCICIO PRÁCTICO CLASES Y HERENCIA
    
    - Se va a simular el funcionamiento de un gestor de personal creando una superclase Employee de la que heredan 3 subclases Manager, ProjectManager y Developer
